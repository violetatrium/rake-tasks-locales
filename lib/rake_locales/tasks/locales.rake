...
namespace :locales do
  # IMPORTANT, make this testing-cicd when updating scripts.
  # Otherwise you run the risk of changing/ deleting all of our translated strings
  desc 'Run all the steps for translations'
  ...
  task transifex_export: [:environment] do
    transifex_export
  end

  desc 'Downlaod transifex db'
  task transifex_import: [:environment] do
    update_public_locales
  end

  desc 'verify transifex'
